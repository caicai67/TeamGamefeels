...
namespace InControl
{
	public class InputDevice
	{
		...
		/// <summary>
		/// Gets the control with the specified control type. If the control does not exist, <c>null</c> is returned.
		/// </summary>
		/// <param name="inputControlType">The control type of the control to get.</param>
		...
		// TODO: Deprecate this in favor of Command.WasPressed
